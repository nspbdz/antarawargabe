$(document).ready(function() {
  ...
  function searchData() {
    ...
    $.ajax({
      ...
      url:"/verifikasi-upload/getVerifikasi",
  ...
  function tableRender( datatl,datadh,datapnp, data) {
    ...
    for(var j=0; j<data.length; j++){
        item += '<td> '+ x +'</td>';
        item += `<td style='white-space: nowrap'><a class="edit btn btn-icon btn-info detail-menu-btn" style="padding:5px; margin-left:5px;" href="verifikasi-upload/`+data[j].id+`" data-toggle="tooltip" data-placement="top" title="Detail Data">
        <i class="bi-eye" aria-hidden="true" id="detail"></i></a>`;
        item +=  `<a class="edit btn btn-icon btn-info detail-menu-btn" style="padding:5px; margin-left:5px;" href="verifikasi-upload/upload-file/`+data[j].id+`" data-toggle="tooltip" data-placement="top" title="Detail Data">
