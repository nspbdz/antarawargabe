...
$("#reset_form").on("click", function (e) {
  ...
  // $('#range_date').val("").datepicker("update");
  ...
  $(".showdropdownspengeluaran").on("apply.daterangepicker", function (ev, picker) {
    $(this).val(
      picker.startDate.format("MM/DD/YYYY") +
      " - " +
      picker.endDate.format("MM/DD/YYYY")
    );
    console.log("date clicked ",$(this).val())
  });

  $(".showdropdownspengeluaran").on("cancel.daterangepicker", function (ev, picker) {
    $(this).val("");
  });

  // Show Dropdowns
  $(".showdropdownspengeluaran").daterangepicker({
  ...
  $(".showdropdownspengeluaran").val('');


   // Picker Translations
   $("#tgl_transaksi_input").pickadate({
