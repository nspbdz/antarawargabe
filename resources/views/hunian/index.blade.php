    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="text-right">
                        <a class="btn btn-xs btn-primary" href="{{ route('hunian.create') }}"> <i class="bx bxs-user-plus"></i> Tambah data </a>
                    </div>
            </div>
            </div>
          <br> </br>
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('hunian.index') }}" data-switchurl="{{ route('hunian.status') }}" data-backurl="{{ route('hunian.index') }}"
...
<script src="{{asset('js/master/hunian/hunian.js')}}"></script>
