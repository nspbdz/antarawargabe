    ...
    <div class="container">
        ...
        <form method="POST" id="search_form" class="form-horizontal">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="masukan Username" id="search"
                            name="search">
                    </div>
                    <div class="col-md-6">
                        <!-- <label for="search">Name</label>
                        <input type="text" class="form-control" placeholder="Masukkan Name" id="search"
                            name="search"> -->
                    </div>
        ...
        <div class="row">
                    ...
                    <div class="text-right">
                        <a class="btn btn-xs btn-primary" href="{{ route('user.create') }}"> <i class="bx bxs-user-plus"></i> Tambah data </a>
                    </div>
            </div>
            </div>
          <br> </br>
