    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="text-right">
                        <a class="btn btn-xs btn-primary" href="{{ route('internal-order.create') }}"> <i class="bx bxs-user-plus"></i> Tambah data </a>
                    </div>
            </div>
            </div>
          <br> </br>
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('internal-order.index') }}" data-switchurl="{{ route('internal-order.status') }}" data-backurl="{{ route('internal-order.index') }}"
...
<script src="{{asset('js/master/internal-order/internal-order.js')}}"></script>
