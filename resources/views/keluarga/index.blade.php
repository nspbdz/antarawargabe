    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="text-right">
                        <a class="btn btn-xs btn-primary" href="{{ route('keluarga.create') }}"> <i class="bx bxs-user-plus"></i> Tambah data </a>
                    </div>
            </div>
            </div>
          <br> </br>
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('keluarga.index') }}" data-switchurl="{{ route('keluarga.status') }}" data-backurl="{{ route('keluarga.index') }}"
